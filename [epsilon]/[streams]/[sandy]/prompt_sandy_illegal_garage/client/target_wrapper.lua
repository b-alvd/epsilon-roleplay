---------------------------------------------------------------------
-- PROMPT SANDY ILLEGAL GARAGE — Target System Wrapper
...
do
    ...
    if Config.Debug then
        if useTarget then
            print('[ILLEGAL GARAGE] Target system: ' .. TargetSystem)
        else
            print('[ILLEGAL GARAGE] No target system — using E-key zones')
        end
    end
end
